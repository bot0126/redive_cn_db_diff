...
INSERT INTO `uek_boss` VALUES (/*area*/4,/*quest_name*/"",/*limit_time*/90,/*reward_type_1*/0,/*reward_id_1*/0,/*reward_num_1*/0,/*reward_type_2*/0,/*reward_id_2*/0,/*reward_num_2*/0,/*reward_type_3*/0,/*reward_id_3*/0,/*reward_num_3*/0,/*reward_type_4*/0,/*reward_id_4*/0,/*reward_num_4*/0,/*reward_type_5*/0,/*reward_id_5*/0,/*reward_num_5*/0,/*background*/0,/*enemy_id*/0,/*bgm_sheet_id*/"0",/*bgm_que_id*/"0",/*detail_bg_id*/0,/*detail_bg_position*/0,/*detail_boss_bg_size*/0.0,/*detail_boss_bg_height*/0,/*result_boss_position_y*/0,/*result_movie*/0);
COMMIT;
