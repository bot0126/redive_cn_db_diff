...
INSERT INTO `cgg_completion_data` VALUES (/*completion_id*/201,/*completion_emblem_id*/11001146,/*gacha_type*/0,/*completion_num*/30,/*secret_goods_id_1*/0,/*secret_goods_id_2*/0,/*secret_goods_id_3*/0,/*description*/"让周边收集率达到50%",/*receive_description*/"由于周边收集率达到了50%，\n获得称号【[FFBB00,CE4F00]慈乐之音全员粉[-]】。");
INSERT INTO `cgg_completion_data` VALUES (/*completion_id*/202,/*completion_emblem_id*/11001147,/*gacha_type*/0,/*completion_num*/60,/*secret_goods_id_1*/10101,/*secret_goods_id_2*/10102,/*secret_goods_id_3*/10103,/*description*/"收集所有种类的周边吧",/*receive_description*/"由于集齐了所有种类的周边，\n获得称号【[FFBB00,CE4F00]慈乐之音狂热粉[-]】。");
COMMIT;
