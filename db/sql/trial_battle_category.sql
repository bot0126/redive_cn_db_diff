...
INSERT INTO `trial_battle_category` VALUES (/*category_id*/4,/*category_name*/"滴水嘴兽·炸裂",/*icon_id*/4,/*label_type_1*/101,/*label_type_2*/202,/*label_type_3*/0,/*description*/"携有刚力浮石的鸟像",/*description_detail*/"该首领怪物具备高物理攻击力，可发动强大的\n范围攻击，有多个受击判定目标。");
INSERT INTO `trial_battle_category` VALUES (/*category_id*/5,/*category_name*/"滴水嘴兽·魔能",/*icon_id*/5,/*label_type_1*/102,/*label_type_2*/202,/*label_type_3*/0,/*description*/"携有魔业浮石的鸟像",/*description_detail*/"该首领怪物具备高魔法攻击力，可发动强大的\n范围攻击，有多个受击判定目标。");
COMMIT;